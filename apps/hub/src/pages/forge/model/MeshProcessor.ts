...
export type ForgeScaleMode = ScaleMode | "depth";

export interface MeshProcessingParams {
  textureResolution: number;
  pivot: PivotPreset;
  scaleMode: ForgeScaleMode;
...
export function computeScaleForDraft(bbox: BBox, mode: ForgeScaleMode, targetValue: number): number {
