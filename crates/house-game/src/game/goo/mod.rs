...
//! creatures — the SPH kernels + PBF passes, the `Goo` component, the crawl/AI
//! `goo_system`, trap pull, shot damage/split, and same-tier fusion (every
//! `GOO_*` knob + balance table lives in `goo/tuning.rs`). These are
