    ...
    pub fn from_timeline(timeline: &[(Tick, GameEvent)], ticks_run: u64) -> Metrics {
        ...
        for (t, ev) in timeline {
            ...
            match ev {
                ...
                GameEvent::MobHit(..) | GameEvent::MobSplit(..) | GameEvent::MobKilled(..) | GameEvent::MobMerged(..) | GameEvent::MobSolidified(..) | GameEvent::GooSplashed(..) | GameEvent::PlayerDown | GameEvent::CardPicked(..) | GameEvent::LightsOut | GameEvent::GooEscaped(..) => {}
            }
        }
