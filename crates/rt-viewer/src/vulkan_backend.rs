...
impl RenderBackend for VulkanBackend {
    ...
    unsafe fn render_present(&mut self, fp: &FramePresent) -> bool {
        ...
        if fp.fs.vegetation {push.env4[3]=fp.fs.time+1.0;push.roi[..3].copy_from_slice(&fp.fs.actor_position);push.misc3[1]=(fp.fs.extent[0]*16.0) as i32;push.misc3[2]=(fp.fs.extent[1]*16.0) as i32;}
