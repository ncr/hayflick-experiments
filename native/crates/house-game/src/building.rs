...
pub fn house_floor(seed: u64) -> LevelSpec {
    ...
    LevelSpec { rooms, static_solids: Vec::new(), doors, lights, targets: Vec::new(), items: Vec::new(), survival: None, mobs: Vec::new(), traps: Vec::new(), player_start: Vec3::new(exc + 0.5, 0.0, h as f32 - 1.5), seed }
}
...
pub fn factory_floor(seed: u64) -> LevelSpec {
    ...
    LevelSpec { rooms, static_solids: Vec::new(), doors, lights, targets: Vec::new(), items: Vec::new(), survival: None, mobs: Vec::new(), traps: Vec::new(), player_start: Vec3::new(((ow + w) / 2) as f32, 0.0, hz), seed }
}
