...
export type PropDefinitionLike = {
  id: string;
  description: string;
  physicsHint?: {
...
export const PHYSICS_MATERIAL_PRESETS: Record<PropPhysicsMaterial, PhysicsMaterialPreset> = {
  default: {
    friction: 0.78,
    restitution: 0.03,
    density: 320,
...
export function inferPhysicsMaterialFromDefinition(
  definition: PropDefinitionLike | null | undefined
): PropPhysicsMaterial {
